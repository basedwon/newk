...
// const PubSubPersist = require('./modules/persist')
// const Entry = require('./modules/entry')
// const Seeder = require('./modules/seeder')
...
class Newk {
  ...
  constructor(opts, transport) {
    ...
    opts.classes = this.constructor.classes
    _.objProp(this, 'registry', new Registry(opts))
